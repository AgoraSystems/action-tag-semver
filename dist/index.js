...
var main = function() {
    var _ref = _asyncToGenerator(function() {
        var options, octokit, ref, mostRecentVersion, releaseType, newVersion;
            ...
            switch(_state.label){
                ...
                case 1:
                    ref = _slicedToArray.apply(void 0, [
                        _state.sent(),
                        2
                    ]), mostRecentVersion = ref[0], releaseType = ref[1];
                    newVersion = semver.inc(mostRecentVersion, releaseType);
                    if (!newVersion) {
                    ...
                    return [
                        4,
                        createTag(octokit, options.versionPrefix + newVersion)
                    ];
                case 2:
                    _state.sent();
                    return [
